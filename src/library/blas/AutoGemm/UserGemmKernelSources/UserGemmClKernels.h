...
extern cl_kernel sgemm_NN_gfx900_tensile_clKernel;
extern cl_kernel sgemm_NT_gfx900_tensile_clKernel;
extern cl_kernel sgemm_TN_gfx900_tensile_clKernel;
extern cl_kernel sgemm_TT_gfx900_tensile_clKernel;
...
static const int user_kernel_count = 15;
