...
#ifndef KERNEL_SGEMM_TT_GFX900_TENSILE_SRC_H
#define KERNEL_SGEMM_TT_GFX900_TENSILE_SRC_H
// #pragma message("AutoGemm's sgemm_TT_gfx900_tensile_src overriden by user.")

const unsigned int sgemm_TT_gfx900_tensile_workGroupNumRows = 8;
const unsigned int sgemm_TT_gfx900_tensile_workGroupNumCols = 8;
const unsigned int sgemm_TT_gfx900_tensile_microTileNumRows = 4;
const unsigned int sgemm_TT_gfx900_tensile_microTileNumCols = 4;
...
unsigned char *sgemm_TT_gfx900_tensile_bin = 0;
size_t sgemm_TT_gfx900_tensile_binSize = 0;
#endif

const char * const sgemm_TT_gfx900_tensile_src = STRINGIFY(
  /******************************************/
  /* Function Prefix                        */
  /******************************************/
...
__kernel void Cijk_Alik_Bjlk_SB_MT032x032x32_GRVW04_K1_PGR1_PLR1_TT04_04_VW04_WG08_08_04_WGM08(
  __global float *C,
...
#define SCALAR_ZERO (float)(0)
  ...
  unsigned int localWriteOffsetA_0_0_0_2 = localWriteFirstOffsetA + (2 + 0*LSCA)*(MT0I+PAD) + (0 + 0*LSPA);
  unsigned int localWriteOffsetA_0_0_0_3 = localWriteFirstOffsetA + (3 + 0*LSCA)*(MT0I+PAD) + (0 + 0*LSPA);
  ...
  __local DATA_TYPE *localWriteA_0_0_0_2;
  __local DATA_TYPE *localWriteA_0_0_0_3;
  ...
  localWriteA_0_0_0_2 = (__local DATA_TYPE *)(localMemory + localWriteOffsetA_0_0_0_2);
  localWriteA_0_0_0_3 = (__local DATA_TYPE *)(localMemory + localWriteOffsetA_0_0_0_3);
  ...
  if (sizeL >= LOCAL_DEPTHU) {
    ...
    *(localWriteA_0_0_0_2 + 0) = a_0_2_0_0;
    *(localWriteA_0_0_0_3 + 0) = a_0_3_0_0;
    ...
    *(localWriteB_0_0_0_0 + 3) = b_0_3_0_0;
    ...
    localWriteOffsetA_0_0_0_2 = (localWriteOffsetA_0_0_0_2 + LDS_OFFSET_BLK)%(LDS_OFFSET_BLK*2);
    localWriteOffsetA_0_0_0_3 = (localWriteOffsetA_0_0_0_3 + LDS_OFFSET_BLK)%(LDS_OFFSET_BLK*2);
  ...
  localWriteOffsetA_0_0_0_2 %= LDS_OFFSET_BLK;
  localWriteOffsetA_0_0_0_3 %= LDS_OFFSET_BLK;
  ...
  a_0_2_0_0 = ( globalReadOffsetAL_0_0 + 2 >= (sizeL % LOCAL_DEPTHU) ) ? SCALAR_ZERO : *(globalReadA_0_0_0_0 + 2);
  a_0_3_0_0 = ( globalReadOffsetAL_0_0 + 3 >= (sizeL % LOCAL_DEPTHU) ) ? SCALAR_ZERO : *(globalReadA_0_0_0_0 + 3);
