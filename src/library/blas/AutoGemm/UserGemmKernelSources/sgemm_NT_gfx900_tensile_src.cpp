...
#ifndef KERNEL_SGEMM_NT_GFX900_TENSILE_SRC_H
#define KERNEL_SGEMM_NT_GFX900_TENSILE_SRC_H
// #pragma message("AutoGemm's sgemm_NT_gfx900_tensile_src overriden by user.")

const unsigned int sgemm_NT_gfx900_tensile_workGroupNumRows = 8;
const unsigned int sgemm_NT_gfx900_tensile_workGroupNumCols = 8;
const unsigned int sgemm_NT_gfx900_tensile_microTileNumRows = 4;
const unsigned int sgemm_NT_gfx900_tensile_microTileNumCols = 4;
...
unsigned char *sgemm_NT_gfx900_tensile_bin = 0;
size_t sgemm_NT_gfx900_tensile_binSize = 0;
#endif

const char * const sgemm_NT_gfx900_tensile_src = STRINGIFY(
  /******************************************/
  /* Function Prefix                        */
  /******************************************/
...
__kernel void Cijk_Ailk_Bjlk_SB_MT032x032x32_GRVW04_K1_PGR1_PLR0_TT04_04_VW04_WG08_08_04_WGM08(
  __global float *C,
...
#define SCALAR_ZERO (float)(0)
  ...
  if (sizeL >= LOCAL_DEPTHU) {
    ...
    a_0_2_0_0 = *(globalReadA_0_0_0_0 + 2);
    a_0_3_0_0 = *(globalReadA_0_0_0_0 + 3);
    ...
    *(localWriteA_0_0_0_0 + 2) = a_0_2_0_0;
    *(localWriteA_0_0_0_0 + 3) = a_0_3_0_0;

    /* local write b */
    *(localWriteB_0_0_0_0 + 0) = b_0_0_0_0;
    *(localWriteB_0_0_0_0 + 1) = b_0_1_0_0;
    *(localWriteB_0_0_0_0 + 2) = b_0_2_0_0;
    *(localWriteB_0_0_0_0 + 3) = b_0_3_0_0;
  ...
  while (numIterL-- > 1) {
    ...
    /* global read inc b */
    globalReadB_0_0_0_0 = (__global DATA_TYPE const *)( ((__global DATA_TYPE const *)globalReadB_0_0_0_0) + globalReadIncBL);
    barrier(CLK_LOCAL_MEM_FENCE); /* 4sync for global read */
  ...
  a_0_2_0_0 = ( globalReadOffsetAL_0_0 + 0 >= (sizeL % LOCAL_DEPTHU) ) ? SCALAR_ZERO : *(globalReadA_0_0_0_0 + 2);
  a_0_3_0_0 = ( globalReadOffsetAL_0_0 + 0 >= (sizeL % LOCAL_DEPTHU) ) ? SCALAR_ZERO : *(globalReadA_0_0_0_0 + 3);
  ...
  b_0_2_0_0 = ( globalReadOffsetBL_0_0 + 0 >= (sizeL % LOCAL_DEPTHU) ) ? SCALAR_ZERO : *(globalReadB_0_0_0_0 + 2);
  b_0_3_0_0 = ( globalReadOffsetBL_0_0 + 0 >= (sizeL % LOCAL_DEPTHU) ) ? SCALAR_ZERO : *(globalReadB_0_0_0_0 + 3);
  barrier(CLK_LOCAL_MEM_FENCE);
  ...
  *(localWriteB_0_0_0_0 + 3) = b_0_3_0_0;
  ...
  if (r0I > 0 && ((wgMT0I/VECTOR_WIDTH) % SG0I) == (serial % SG0I) ) {
    ...
    if (r0I == 1) {
      {
        rC[0 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 0*TT0I] = rC[3 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 0*TT0I];
        rC[0 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 1*TT0I] = rC[3 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 1*TT0I];
        rC[0 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 2*TT0I] = rC[3 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 2*TT0I];
        rC[0 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 3*TT0I] = rC[3 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 3*TT0I];
      }
    }
    if (r0I == 2) {
      {
        rC[0 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 0*TT0I] = rC[2 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 0*TT0I];
        rC[1 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 0*TT0I] = rC[3 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 0*TT0I];
        rC[0 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 1*TT0I] = rC[2 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 1*TT0I];
        rC[1 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 1*TT0I] = rC[3 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 1*TT0I];
        rC[0 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 2*TT0I] = rC[2 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 2*TT0I];
        rC[1 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 2*TT0I] = rC[3 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 2*TT0I];
        rC[0 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 3*TT0I] = rC[2 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 3*TT0I];
        rC[1 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 3*TT0I] = rC[3 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 3*TT0I];
      }
    }
    if (r0I == 3) {
      {
        rC[0 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 0*TT0I] = rC[1 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 0*TT0I];
        rC[1 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 0*TT0I] = rC[2 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 0*TT0I];
        rC[2 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 0*TT0I] = rC[3 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 0*TT0I];
        rC[0 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 1*TT0I] = rC[1 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 1*TT0I];
        rC[1 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 1*TT0I] = rC[2 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 1*TT0I];
        rC[2 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 1*TT0I] = rC[3 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 1*TT0I];
        rC[0 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 2*TT0I] = rC[1 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 2*TT0I];
        rC[1 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 2*TT0I] = rC[2 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 2*TT0I];
        rC[2 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 2*TT0I] = rC[3 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 2*TT0I];
        rC[0 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 3*TT0I] = rC[1 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 3*TT0I];
        rC[1 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 3*TT0I] = rC[2 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 3*TT0I];
        rC[2 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 3*TT0I] = rC[3 + 0*GLOBAL_LOAD_VECTOR_WIDTH_A + 3*TT0I];
      }
    }
  }
  ...
  if (r1J > 0 && ((wgMT1J/VECTOR_WIDTH) % SG1J) == (serial / SG0I) % SG1J ) {
    ...
    if (r1J == 1) {
      {
        rC[0 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 0*TT0I] = rC[0 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 3*TT0I];
        rC[1 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 0*TT0I] = rC[1 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 3*TT0I];
        rC[2 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 0*TT0I] = rC[2 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 3*TT0I];
        rC[3 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 0*TT0I] = rC[3 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 3*TT0I];
      }
    }
    if (r1J == 2) {
      {
        rC[0 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 0*TT0I] = rC[0 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 2*TT0I];
        rC[0 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 1*TT0I] = rC[0 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 3*TT0I];
        rC[1 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 0*TT0I] = rC[1 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 2*TT0I];
        rC[1 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 1*TT0I] = rC[1 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 3*TT0I];
        rC[2 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 0*TT0I] = rC[2 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 2*TT0I];
        rC[2 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 1*TT0I] = rC[2 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 3*TT0I];
        rC[3 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 0*TT0I] = rC[3 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 2*TT0I];
        rC[3 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 1*TT0I] = rC[3 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 3*TT0I];
      }
    }
    if (r1J == 3) {
      {
        rC[0 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 0*TT0I] = rC[0 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 1*TT0I];
        rC[0 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 1*TT0I] = rC[0 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 2*TT0I];
        rC[0 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 2*TT0I] = rC[0 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 3*TT0I];
        rC[1 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 0*TT0I] = rC[1 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 1*TT0I];
        rC[1 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 1*TT0I] = rC[1 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 2*TT0I];
        rC[1 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 2*TT0I] = rC[1 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 3*TT0I];
        rC[2 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 0*TT0I] = rC[2 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 1*TT0I];
        rC[2 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 1*TT0I] = rC[2 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 2*TT0I];
        rC[2 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 2*TT0I] = rC[2 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 3*TT0I];
        rC[3 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 0*TT0I] = rC[3 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 1*TT0I];
        rC[3 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 1*TT0I] = rC[3 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 2*TT0I];
        rC[3 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 2*TT0I] = rC[3 + 0*TT0I*GLOBAL_LOAD_VECTOR_WIDTH_B + 3*TT0I];
      }
    }
  }
