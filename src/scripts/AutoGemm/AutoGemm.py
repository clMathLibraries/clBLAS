...
# [ size, [ valid tiles ], fallback tile],
  "s":[
    [ 6144, [ 16, 16,  5,  5], [ [ 16, 16,  5,  5], [ 16, 16,  8,  8], [ 16, 16,  7,  7], [ 16, 16,  4,  4] ] ],
    [ 4080, [ 16, 16,  5,  5], [ [ 16, 16,  5,  5], [ 16, 16,  7,  7], [ 16, 16,  8,  8], [ 16, 16,  4,  4] ] ],
    [ 2880, [ 16, 16,  4,  4], [ [ 16, 16,  5,  5], [ 16, 16,  4,  4], [ 16, 16,  7,  7], [ 16, 16,  6,  6] ] ],
    [ 1424, [ 16, 16,  4,  4], [ [ 16, 16,  4,  4], [ 16, 16,  5,  5], [ 16, 16,  7,  7], [ 16, 16,  6,  6], [ 16, 16,  3,  3] ] ],
    [  896, [ 16, 16,  2,  2], [ [ 16, 16,  4,  4], [ 16, 16,  5,  5], [ 16, 16,  7,  7], [ 16, 16,  3,  3], [ 16, 16,  6,  6], [ 16, 16,  2,  2] ] ],
    [  560, [ 16, 16,  2,  2], [ [ 16, 16,  4,  4], [ 16, 16,  5,  5], [ 16, 16,  3,  3], [ 16, 16,  2,  2], [ 16, 16,  1,  1] ] ],
    [  304, [ 16, 16,  1,  1], [ [ 16, 16,  3,  3], [ 16, 16,  2,  2], [ 16, 16,  1,  1] ] ],
    [    0, [ 16, 16,  1,  1], [ [ 16, 16,  1,  1] ] ],
    ],
  "d":[
