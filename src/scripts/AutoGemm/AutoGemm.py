...
# [ size, [ valid tiles ], fallback tile],
  ...
  "d":[
      [    0, [ 16, 16, 1, 1], [ [ 16, 16, 1, 1] ] ],
      [  256, [ 16, 16, 2, 2], [ [ 16, 16, 2, 2] ] ],
      [  384, [ 16, 16, 2, 4], [ [ 16, 16, 2, 4] ] ],
      [  450, [ 16, 16, 2,10], [ [ 16, 16, 2,10] ] ],
      [  512, [ 16, 16, 4, 4], [ [ 16, 16, 4, 4] ] ],
      [  800, [ 16, 16, 4, 8], [ [ 16, 16, 4, 8] ] ],
      [ 1024, [ 16, 16, 6, 6], [ [ 16, 16, 6, 6] ] ],
      ],
  "c":[
      [    0, [ 16, 16, 1, 1], [ [ 16, 16, 1, 1] ] ],
      [  256, [ 16, 16, 2, 2], [ [ 16, 16, 2, 2] ] ],
...
def processAllKernelParameterCombinations(argv):
  ...
  for precision in listPrecision:
    ...
    for sizeData in kernelSelectionData[precision]:
      validTiles = sizeData[1]
      fallbackTile = sizeData[2]
      # add valid tiles
