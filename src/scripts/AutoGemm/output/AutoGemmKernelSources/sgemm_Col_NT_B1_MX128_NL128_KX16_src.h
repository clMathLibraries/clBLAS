...
#ifndef KERNEL_SGEMM_COL_NT_B1_MX128_NL128_KX16_SRC_H
#define KERNEL_SGEMM_COL_NT_B1_MX128_NL128_KX16_SRC_H

const unsigned int sgemm_Col_NT_B1_MX128_NL128_KX16_workGroupNumRows = 16;
const unsigned int sgemm_Col_NT_B1_MX128_NL128_KX16_workGroupNumCols = 16;
const unsigned int sgemm_Col_NT_B1_MX128_NL128_KX16_microTileNumRows = 8;
const unsigned int sgemm_Col_NT_B1_MX128_NL128_KX16_microTileNumCols = 8;
const unsigned int sgemm_Col_NT_B1_MX128_NL128_KX16_unroll = 16;

static const char * const sgemm_Col_NT_B1_MX128_NL128_KX16_src ="\n"
"/* sgemm_Col_NT_B1_MX128_NL128_KX16 */\n"
"\n"
"/* kernel parameters */\n"
...
"__kernel void sgemm_Col_NT_B1_MX128_NL128_KX16(\n"
...
"  if (globalCCol+6*WG_NUM_COLS < N){  TYPE_MAD_WRITE( C[ GET_GLOBAL_INDEX_C( globalCRow+0*WG_NUM_ROWS, globalCCol+6*WG_NUM_COLS) ], alpha, rC[0][6], beta )}\n"
"  if (globalCCol+7*WG_NUM_COLS < N){  TYPE_MAD_WRITE( C[ GET_GLOBAL_INDEX_C( globalCRow+0*WG_NUM_ROWS, globalCCol+7*WG_NUM_COLS) ], alpha, rC[0][7], beta )}\n"
...
"  if (globalCCol+6*WG_NUM_COLS < N){  TYPE_MAD_WRITE( C[ GET_GLOBAL_INDEX_C( globalCRow+1*WG_NUM_ROWS, globalCCol+6*WG_NUM_COLS) ], alpha, rC[1][6], beta )}\n"
"  if (globalCCol+7*WG_NUM_COLS < N){  TYPE_MAD_WRITE( C[ GET_GLOBAL_INDEX_C( globalCRow+1*WG_NUM_ROWS, globalCCol+7*WG_NUM_COLS) ], alpha, rC[1][7], beta )}\n"
...
"  if (globalCCol+6*WG_NUM_COLS < N){  TYPE_MAD_WRITE( C[ GET_GLOBAL_INDEX_C( globalCRow+2*WG_NUM_ROWS, globalCCol+6*WG_NUM_COLS) ], alpha, rC[2][6], beta )}\n"
"  if (globalCCol+7*WG_NUM_COLS < N){  TYPE_MAD_WRITE( C[ GET_GLOBAL_INDEX_C( globalCRow+2*WG_NUM_ROWS, globalCCol+7*WG_NUM_COLS) ], alpha, rC[2][7], beta )}\n"
...
"  if (globalCCol+6*WG_NUM_COLS < N){  TYPE_MAD_WRITE( C[ GET_GLOBAL_INDEX_C( globalCRow+3*WG_NUM_ROWS, globalCCol+6*WG_NUM_COLS) ], alpha, rC[3][6], beta )}\n"
"  if (globalCCol+7*WG_NUM_COLS < N){  TYPE_MAD_WRITE( C[ GET_GLOBAL_INDEX_C( globalCRow+3*WG_NUM_ROWS, globalCCol+7*WG_NUM_COLS) ], alpha, rC[3][7], beta )}\n"
...
"  if (globalCCol+6*WG_NUM_COLS < N){  TYPE_MAD_WRITE( C[ GET_GLOBAL_INDEX_C( globalCRow+4*WG_NUM_ROWS, globalCCol+6*WG_NUM_COLS) ], alpha, rC[4][6], beta )}\n"
"  if (globalCCol+7*WG_NUM_COLS < N){  TYPE_MAD_WRITE( C[ GET_GLOBAL_INDEX_C( globalCRow+4*WG_NUM_ROWS, globalCCol+7*WG_NUM_COLS) ], alpha, rC[4][7], beta )}\n"
...
"  if (globalCCol+6*WG_NUM_COLS < N){  TYPE_MAD_WRITE( C[ GET_GLOBAL_INDEX_C( globalCRow+5*WG_NUM_ROWS, globalCCol+6*WG_NUM_COLS) ], alpha, rC[5][6], beta )}\n"
"  if (globalCCol+7*WG_NUM_COLS < N){  TYPE_MAD_WRITE( C[ GET_GLOBAL_INDEX_C( globalCRow+5*WG_NUM_ROWS, globalCCol+7*WG_NUM_COLS) ], alpha, rC[5][7], beta )}\n"
...
"  if (globalCCol+4*WG_NUM_COLS < N){  TYPE_MAD_WRITE( C[ GET_GLOBAL_INDEX_C( globalCRow+6*WG_NUM_ROWS, globalCCol+4*WG_NUM_COLS) ], alpha, rC[6][4], beta )}\n"
"  if (globalCCol+5*WG_NUM_COLS < N){  TYPE_MAD_WRITE( C[ GET_GLOBAL_INDEX_C( globalCRow+6*WG_NUM_ROWS, globalCCol+5*WG_NUM_COLS) ], alpha, rC[6][5], beta )}\n"
"  if (globalCCol+6*WG_NUM_COLS < N){  TYPE_MAD_WRITE( C[ GET_GLOBAL_INDEX_C( globalCRow+6*WG_NUM_ROWS, globalCCol+6*WG_NUM_COLS) ], alpha, rC[6][6], beta )}\n"
"  if (globalCCol+7*WG_NUM_COLS < N){  TYPE_MAD_WRITE( C[ GET_GLOBAL_INDEX_C( globalCRow+6*WG_NUM_ROWS, globalCCol+7*WG_NUM_COLS) ], alpha, rC[6][7], beta )}\n"
...
"  if (globalCCol+4*WG_NUM_COLS < N){  TYPE_MAD_WRITE( C[ GET_GLOBAL_INDEX_C( globalCRow+7*WG_NUM_ROWS, globalCCol+4*WG_NUM_COLS) ], alpha, rC[7][4], beta )}\n"
"  if (globalCCol+5*WG_NUM_COLS < N){  TYPE_MAD_WRITE( C[ GET_GLOBAL_INDEX_C( globalCRow+7*WG_NUM_ROWS, globalCCol+5*WG_NUM_COLS) ], alpha, rC[7][5], beta )}\n"
"  if (globalCCol+6*WG_NUM_COLS < N){  TYPE_MAD_WRITE( C[ GET_GLOBAL_INDEX_C( globalCRow+7*WG_NUM_ROWS, globalCCol+6*WG_NUM_COLS) ], alpha, rC[7][6], beta )}\n"
"  if (globalCCol+7*WG_NUM_COLS < N){  TYPE_MAD_WRITE( C[ GET_GLOBAL_INDEX_C( globalCRow+7*WG_NUM_ROWS, globalCCol+7*WG_NUM_COLS) ], alpha, rC[7][7], beta )}\n"
"\n"
"}\n"
"";
